...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] strs = {"moon river.mp3","yellow.mp3","beauty and the beast.mp3","always with me.mp3"};
        ArrayAdapter adapter = new ArrayAdapter(this,R.layout.color,strs);
        list.setAdapter(adapter);
        btnPlayOrPause = (Button)this.findViewById(R.id.BtnPlayorPause);

        Log.d("hint", Environment.getExternalStorageDirectory().getAbsolutePath()+"/Music/moon river.mp3");
    }
